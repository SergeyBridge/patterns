...
class EasyLevel(AbstractLevel):
    ...
    def from_yaml(cls, _loader, _node):
        ...
        def get_easy_level(_loader, _node):
            objects = _loader.construct_mapping(_node, deep=True)
            _map = cls.get_map()
            _obj = cls.get_objects()
            _obj.config = objects
            result = {"map": _map, "obj": _obj}
            return result

        _loader.add_constructor(u"!easy_level", get_easy_level)

        return _loader.construct_mapping(_node)
...
class MediumLevel(AbstractLevel):
    ...
    def from_yaml(cls, _loader, _node):
        ...
        def get_medium_level(_loader, _node):
            objects = _loader.construct_mapping(_node, deep=True)
            _map = cls.get_map()
            _obj = cls.get_objects()
            _obj.config = objects
        ...
        _loader.add_constructor(u"!medium_level", get_medium_level)

        return _loader.construct_mapping(_node, deep=True)
...
class HardLevel(AbstractLevel):
    ...
    def from_yaml(cls, _loader, _node):
        ...
        def get_hard_level(_loader, _node):
            objects = _loader.construct_mapping(_node, deep=True)
            _map = cls.get_map()
            _obj = cls.get_objects()
            _obj.config = objects
        ...
        _loader.add_constructor(u"!hard_level", get_hard_level)
